...
void CEditor::generateStaticData() {
        ...
        // Relations (static data):
        {
            ...
            gPlanePartRelations.emplace_back(400, B1, R4, _2d_tbody1 - _2d_rght4, XY(-128, 59), NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Rx", "RxR1R2R3");
            gPlanePartRelations.emplace_back(600, B1, L4, _2d_tbody1 - _2d_left4, XY(42, -93), NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Lx", "LxL1L2L3");
            gPlanePartRelations.emplace_back(401, B1, R5, _2d_tbody1 - _2d_rght5, XY(-66, 58), NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Rx", "RxR1R2R3");
            gPlanePartRelations.emplace_back(601, B1, L5, _2d_tbody1 - _2d_left5, XY(35, -46), NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Lx", "LxL1L2L3");

            gPlanePartRelations.emplace_back(411, B2, R1, _2d_tbody2b - _2d_rght1, rbody2b - rwing1, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Rx", "RxR1R2R3");
            gPlanePartRelations.emplace_back(611, B2, L1, _2d_tbody2b - _2d_left1, lbody2b - lwing1, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Lx", "LxL1L2R5");
            gPlanePartRelations.emplace_back(413, B2, R1, _2d_tbody2d - _2d_rght1, rbody2d - rwing1, NOTE_STD, NOTE_STD, NOTE_STD, -400, 0, "Rx", "RxR4");
            gPlanePartRelations.emplace_back(613, B2, L1, _2d_tbody2d - _2d_left1, lbody2d - lwing1, NOTE_STD, NOTE_STD, NOTE_STD, -400, 0, "Lx", "LxL4");

            gPlanePartRelations.emplace_back(420, B2, R2, _2d_tbody2a - _2d_rght2, rbody2a - rwing2, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Rx", "RxR1R2");
            gPlanePartRelations.emplace_back(620, B2, L2, _2d_tbody2a - _2d_left2, lbody2a - lwing2, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Lx", "LxL1L2");
            gPlanePartRelations.emplace_back(421, B2, R2, _2d_tbody2b - _2d_rght2, rbody2b - rwing2, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Rx", "RxR1R2R3");
            gPlanePartRelations.emplace_back(621, B2, L2, _2d_tbody2b - _2d_left2, lbody2b - lwing2, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Lx", "LxL1L2R5");
            gPlanePartRelations.emplace_back(422, B2, R2, _2d_tbody2c - _2d_rght2, rbody2c - rwing2, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Rx", "RxR2R3");
            gPlanePartRelations.emplace_back(622, B2, L2, _2d_tbody2c - _2d_left2, lbody2c - lwing2, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Lx", "LxL2L3");
            gPlanePartRelations.emplace_back(423, B2, R2, _2d_tbody2d - _2d_rght2, rbody2d - rwing2, NOTE_STD, NOTE_STD, NOTE_STD, -400, 0, "Rx", "RxR4");
            gPlanePartRelations.emplace_back(623, B2, L2, _2d_tbody2d - _2d_left2, lbody2d - lwing2, NOTE_STD, NOTE_STD, NOTE_STD, -400, 0, "Lx", "LxL4");

            gPlanePartRelations.emplace_back(424, B2, R3, _2d_tbody2b - _2d_rght3, rbody2b - rwing3, NOTE_STD, NOTE_STD, NOTE_STD, -400, 0, "Rx", "RxR1R2R3");
            gPlanePartRelations.emplace_back(624, B2, L3, _2d_tbody2b - _2d_left3, lbody2b - lwing3, NOTE_STD, NOTE_STD, NOTE_STD, -400, 0, "Lx", "LxL1L2R5");

            gPlanePartRelations.emplace_back(430, B2, R4, _2d_tbody2a - _2d_rght4, rbody2a - rwing4, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Rx", "RxR1R2");
            gPlanePartRelations.emplace_back(630, B2, L4, _2d_tbody2a - _2d_left4, lbody2a - lwing4, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Lx", "LxL1L2");
            gPlanePartRelations.emplace_back(431, B2, R4, _2d_tbody2b - _2d_rght4, rbody2b - rwing4, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Rx", "RxR1R2R3");
            gPlanePartRelations.emplace_back(631, B2, L4, _2d_tbody2b - _2d_left4, lbody2b - lwing4, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Lx", "LxL1L2R5");
            gPlanePartRelations.emplace_back(432, B2, R4, _2d_tbody2c - _2d_rght4, rbody2c - rwing4, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Rx", "RxR2R3");
            gPlanePartRelations.emplace_back(632, B2, L4, _2d_tbody2c - _2d_left2, lbody2c - lwing4, NOTE_STD, NOTE_STD, NOTE_STD, 0, 0, "Lx", "LxL2L3");
            gPlanePartRelations.emplace_back(433, B2, R4, _2d_tbody2d - _2d_rght4, rbody2d - rwing4, NOTE_STD, NOTE_STD, NOTE_STD, -400, 0, "Rx", "RxR4");
            gPlanePartRelations.emplace_back(633, B2, L4, _2d_tbody2d - _2d_left4, lbody2d - lwing4, NOTE_STD, NOTE_STD, NOTE_STD, -400, 0, "Lx", "LxL4");

            gPlanePartRelations.emplace_back(444, B2, R6, _2d_tbody2b - _2d_rght6, rbody2b - rwing6, NOTE_STD, NOTE_STD, NOTE_STD, -400, 0, "Rx", "RxR1R2R3");
            gPlanePartRelations.emplace_back(644, B2, L6, _2d_tbody2b - _2d_left6, lbody2b - lwing6, NOTE_STD, NOTE_STD, NOTE_STD, -400, 0, "Lx", "LxL1L2R5");
            ...
            gPlanePartRelations.emplace_back(846, R2, M7, _2d_m_rwing2c - _2d_motor7, m_rwing2c - motor7, NOTE_KAPUTTXL, NOTE_PILOT1, NOTE_STD, 3000, 0, "M3", "M2M3");
            ...
            gPlanePartRelations.emplace_back(946, R3, M7, _2d_m_rwing3c - _2d_motor7, m_rwing3c - motor7, NOTE_KAPUTTXL, NOTE_PILOT1, NOTE_STD, 3000, 0, "M3", "M2M3");
...
SLONG GetPlaneBuildIndex(const CString &Shortname) {
    for (SLONG c = 0; c < gPlaneBuilds.size(); c++) {
