...
void CStdRaum::MenuRepaint() {
    ...
    case MENU_BUYKEROSIN:
        if (qPlayer.GetRoom() == ROOM_ARAB_AIR) {
            ...
            if (gLanguage == LANGUAGE_O) {
                OnscreenBitmap.PrintAt(bprintf("%s barris", LPCTSTR(Insert1000erDots(qPlayer.Tank))), FontSmallBlack, TEC_FONT_LEFT, 200, 50, 325, 113);
            } else {
                OnscreenBitmap.PrintAt(bprintf("%s barrel", LPCTSTR(Insert1000erDots(qPlayer.Tank))), FontSmallBlack, TEC_FONT_LEFT, 200, 50, 325, 113);
            }

            if (gLanguage == LANGUAGE_O) {
                OnscreenBitmap.PrintAt(bprintf("%s barris", LPCTSTR(Insert1000erDots(qPlayer.TankInhalt))), FontSmallBlack, TEC_FONT_RIGHT, 56, 76, 200, 113);
            } else {
                OnscreenBitmap.PrintAt(bprintf("%s barrel", LPCTSTR(Insert1000erDots(qPlayer.TankInhalt))), FontSmallBlack, TEC_FONT_RIGHT, 56, 76, 200, 113);
            }
            OnscreenBitmap.PrintAt(Einheiten[EINH_P].bString(qPlayer.TankInhalt * 100 / _tank), FontSmallBlack, TEC_FONT_RIGHT, 56, 76, 236, 113);
            ...
            if (gLanguage == LANGUAGE_O) {
                OnscreenBitmap.PrintAt(bprintf("%s barris", LPCTSTR(Insert1000erDots((MenuPar2 + qPlayer.TankInhalt)))), FontSmallBlack, TEC_FONT_RIGHT, 0, 102,
                                       200, 160);
            } else {
                OnscreenBitmap.PrintAt(bprintf("%s barrel", LPCTSTR(Insert1000erDots((MenuPar2 + qPlayer.TankInhalt)))), FontSmallBlack, TEC_FONT_RIGHT, 0, 102,
                                       200, 160);
            }
